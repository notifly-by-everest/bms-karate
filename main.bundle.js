...
var environment = {
    production: false,
    org_name: "BMS Karate",
    org_tagline: 'Approach, Leadership and Results. THAT’S THE BMS DIFFERENCE.',
    org_city: 'Woodbridge West',
    org_region: 'ON',
    org_logo_url: './assets/images/bms_logo.png',
    base_url: 'https://us-central1-bms-karate.cloudfunctions.net'
};
